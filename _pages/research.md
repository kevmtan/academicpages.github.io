...
### DMN at rest
Why is DMN so active during rest, what is it really doing? What are the interrelations between resting and goal-oriented DMN activity? Can DMN activity at rest influence the performance of DMN-related tasks? For example, can pre-stimulus DMN activity bias perceptions of threat, trustworthiness, and attractiveness?
